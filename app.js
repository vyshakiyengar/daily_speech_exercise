...
function steps(session) {
 ...
 const focus=[
 'First, notice how your voice feels.',
 'Now let’s work on an easy breath.',
 'Now let’s work on crisp sounds.',
 'Now put those sounds into real phrases.',
 'Now let’s work on pauses and flow.',
 'Now try it without a script.',
 'Now compare with your starting sentence.'
 ];
 return [
 {title:'Say this aloud.',short:'Your starting sentence',phase:'01 / CHECK IN',instruction:'Use your normal voice. You’ll repeat this sentence at the end.',label:'YOUR BEFORE & AFTER SENTENCE',quote:cue,tip:'You don’t need to sound a certain way. Simply notice your pace and how much effort speaking takes.'},
