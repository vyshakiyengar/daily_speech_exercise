...
function steps(session) {
 ...
 return [
 {title:'Start with your voice',short:'Before',instruction:'Say this normally so you can compare how speaking feels at the end.',quote:cue,tip:'Notice clarity and effort without changing your accent or trying to sound a certain way; this is a personal comparison, not a scored test.'},
 {title:'Breathe into words',short:'Breath → words',instruction:'Take an easy breath before each line to practice speaking without rushing or squeezing out the last words.',phrases:['Here is my update.','Let’s take one step at a time.'],tip:'Use your normal breath size and volume; breathe again whenever you need to. Do not hold your breath or force a long exhale. Stop if you feel dizzy or strained.'},
 {title:'Wake up each sound',short:'Lips & tongue',instruction:'Say each line twice with slightly bigger, comfortable mouth movements to practice distinct sounds.',phrases:['oo — ee → you and me','pa — ba → paper bag','ta — da → today','ka — ga → keep going'],tip:'Say the sounds aloud as your lips and tongue move. The animation illustrates only oo-to-ee lip shapes; it is not a model of every sound. Use gentle effort, not force; stop if it hurts.'},
 {title:'Clear, then conversational',short:'Clear phrases',instruction:'Read all four phrases with slightly exaggerated sounds, then naturally, to carry clarity into everyday speech.',phrases:phraseSets[daySeed(session.date)%phraseSets.length],tip:'Read the list once with deliberate sounds, then once in your usual speaking style. Aim for clear words without speaking louder, faster, or harder.'},
 {title:'Change the meaning',short:'Word emphasis',instruction:'Stress the blue word each time to hear how emphasis changes your message.',phrases:words.map(()=>emphasis),emphasis:words,tip:'Give the highlighted word a little extra length or pitch change; you do not need to raise your volume. Notice whether you draw attention to who, what, or when.'},
 {title:'Try your next conversation',short:'Your conversation',instruction:({meeting:'Give a two-sentence meeting update',everyday:'Describe one thing from your day',presentation:'Introduce your idea and give an example'}[session.intent])+', pausing between ideas to put your practice to use.',quote:{everyday:'“One thing that happened today…”',meeting:'“The main update is…”',presentation:'“The idea I’d like to share is…”'}[session.intent],tip:'Use your usual speaking style, keep the words clear, and pause when you need to. You can restart or change your words; this is rehearsal, not a performance.'},
 {title:'Notice what changed',short:'After',instruction:'Say your first sentence normally again and compare clarity and effort; no change is useful feedback too.',quote:cue,tip:'Repeating a familiar sentence can itself make it feel easier. Your impression is not proof of lasting improvement or a clinical assessment.'}
